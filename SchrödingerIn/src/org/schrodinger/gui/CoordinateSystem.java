...
//
	...
	int xsize;
	int ysize;
	public ArrayList<Funktion> funktions = new ArrayList<>();
	ArrayList<double[][]> measure = new ArrayList<>();
	ArrayList<Double> energy = new ArrayList<>();
	public ArrayList<Double> solEnergy = new ArrayList<>();

	public ArrayList<ArrayList<Loesungskurve>> simulation = new ArrayList<>();
	public ArrayList<Loesungskurve> solution = new ArrayList<>();
